...
declareDefault("SELSETUP", "allCutsAtOnce", globals())
...
if SELSETUP=="Legacy" and not BESTCANDCOMPARATOR=="byBestZqq":
...
if (LEPTON_SETUP == 2016): #DeepCSV, from https://twiki.cern.ch/twiki/bin/viewauth/CMS/BtagRecommendation2016Legacy
   ...
   sys.exit("ZZ2l2qAnalysis.py: Need to define the btagging for the new setup!")
